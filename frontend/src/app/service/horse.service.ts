...
export class HorseService {
   ...
   *
   * @param horse the data to be modified for the horse (only contains optional data and no id)
   * @return observable of the same horse
   */
   ...
   * @return observable with no content if succeeded
   */
