...
DELETE FROM standings WHERE horse_id < 0
...
-- Füge Tournierdaten hinzu
INSERT INTO tournament (id, name, start_date, end_date)
VALUES
    (-1, 'Spring Championship', '2023-03-01', '2023-03-05'),
    (-2, 'Summer Derby', '2023-06-10', '2023-06-15'),
    (-3, 'Autumn Challenge', '2023-09-20', '2023-09-25'),
    (-4, 'Winter Cup', '2023-12-05', '2023-12-10'),
    (-5, 'National Equestrian Contest', '2023-07-15', '2023-07-20'),
    (-6, 'Horseman Festival', '2023-10-25', '2023-10-30'),
    (-7, 'Riders Gala', '2023-05-05', '2023-05-10'),
    (-8, 'Mountain Race', '2023-08-12', '2023-08-17'),
    (-9, 'Beachside Derby', '2023-04-20', '2023-04-25'),
    (-10, 'Valley Trot', '2023-11-08', '2023-11-13');

-- Füge Turnierteilnehmer (horses) hinzu
